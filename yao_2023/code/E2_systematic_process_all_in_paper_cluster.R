...
output_dir <- file.path(work_directory, "yao_2023/data/intermediate_data/E2_pairwise")
dir.create(output_dir, recursive = TRUE, showWarnings = FALSE)
dir.create(file.path(work_directory, "yao_2023/log/"), recursive = TRUE, showWarnings = FALSE)
...
log_file <- file.path(work_directory, "yao_2023/log/E2_logs.txt")
...
summary_results <- foreach(
  ...
  output_filename <- file.path(output_dir, paste0(treatment1_name, "_", treatment2_name, ".rds"))
