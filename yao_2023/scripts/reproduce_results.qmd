...
# source(file.path(code_directory, 'D1_establish_clustering.R'),
#        local = TRUE)
# source(file.path(code_directory, 'D2_establish_clustering.R'),
#        local = TRUE)
# source(file.path(code_directory, 'E1_truncate_gene_list.R'),
#         local = TRUE)
# system2("Rscript", file.path(code_directory, "E2_systematic_process_all_in_paper_cluster.R"))
```
